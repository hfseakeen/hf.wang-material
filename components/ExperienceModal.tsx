...
const mixedData: ExperienceItem[] = [
  {
    ...
    role: '摄影师 / 摄像师',
    company: '杭州六美传媒有限公司',
    description: '创立摄影工作室是想要构建纯粹的视觉美学。在企业里，视觉往往需要向多方业务线妥协；但在自己的工作室，我可以将极致的光影控制、以及对产品严苛的精修标准，毫无保留地应用到每一次商业拍摄中。工作室将我从专业核心向“六边形主理人”升维，不仅输出极致视觉，更打通了商业闭环（成本核算、流量运营、客户维系），完成从执行者到商业操盘手的身份转换。',
  ...
  },
  {
    ...
    description: '深耕电商摄影业务内核，从0到1搭建全品类摄影体系。通过极致的光影控制与后期，将高级视觉直接转化为商业杠杆，助力爆款打造（提升电商转化率 &GMV），完成了从视觉专家到主导者的升维。我意识到，是时候打破企业的框架，去构建完全属于自己的品牌阵地了。',
  ...
  },
  {
    ...
    role: '视觉设计师',
    company: 'K3 SPACE',
    description: '拥抱顶尖审美与国际化视野，参与京东、原研哉合作项目打磨极简美 学。完成了从 “做图” 到 “做系统” 的思维转变，深刻理解了品牌全 案控盘下，视觉语言在多端保持高度统一性与延展性的逻辑。但同时 我也想系统化的了解一个品牌或者领域如何从 0 到 1 的一个过程。',
    tags: ['品牌设计', 'VI系统', '视觉策划'],
    type: 'work'
  },
  {
    ...
    role: '品牌设计师',
    company: '正邦',
    description: '选择正邦旨在探寻顶尖的系统化设计逻辑。这段短暂经历开启了我从“感性创作”到“理性商业设计”的启蒙，学会了严谨的VI规范，建立了高标准的品牌系统观，但大公司高度细分的流水线作业，也让我明确了渴望的是拥有更高项目掌控权。',
    tags: ['品牌设计', 'VI系统', '视觉策划'],
    type: 'work'
  },
  {
